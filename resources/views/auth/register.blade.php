        ...
        <div class="col-xl-5 col-lg-6 col-md-8">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="名古屋 飯太郎">
                    </div>
                </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" id="kana" name="kana" value="{{ old('kana') }}" required pattern="\A[ァ-ヴー\s]+\z" title="フリガナは全角カタカナで入力してください。" placeholder="ナゴヤ メシタロウ">
                    </div>
                </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" id="postal_code" name="postal_code" value="{{ old('postal_code') }}" required pattern="[0-9]{7}" title="郵便番号は7桁の半角数字で入力してください。" maxlength="7" autocomplete="postal-code" placeholder="4500002">
                    </div>
                </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" id="address" name="address" value="{{ old('address') }}" required placeholder="愛知県名古屋市中村区名駅1丁目">
                    </div>
                </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" id="birthday" name="birthday" value="{{ old('birthday') }}" pattern="[0-9]{8}" title="誕生日は8桁の半角数字で入力してください。" maxlength="8" autocomplete="bday" placeholder="19980501">
                    </div>
                </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-7">
                        <input type="text" class="form-control" id="occupation" name="occupation" value="{{ old('occupation') }}" placeholder="フリーランスエンジニア">
                    </div>
                </div>
                ...
                <div class="form-group row mb-3">
                    ...
                    <div class="col-md-7">
                        <input type="email" class="form-control" id="email" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="meshitaro.nagoya@example.com">
                    </div>
                </div>
